...
from pyegeria import CollectionManager, EgeriaTech
from textual import on
from textual.app import App
from textual.message import Message
from splash_screen import SplashScreen
from dan_data_product_screen import DataProductScreen
...
class DataProducts(App):
    ...
    def __init__(self):
        ...
        self.c_client = CollectionManager(self.view_server, self.platform_url, user_id=self.user, )
        self.c_client.create_egeria_bearer_token(self.user, self.password)
    ...
    def handle_splash_screen_splash_continue(self):
        ...
        self.collections = self.get_collections_from_egeria( Search_str = "*")
    ...
    def get_collections_from_egeria(self, Search_str: str) -> list:
        self.log(f"Creating client and Connecting to Egeria using: , {self.Egeria_config}")
        ...
        try:
            ...
            response = self.c_client.find_collections(search_string=Search_str, output_format="DICT")
            # response = self.c_client._async_find_collections(search_string=Search_str, output_format="DICT")
