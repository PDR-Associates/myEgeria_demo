...
class DataProductScreen(Screen):
    ...
    async def on_collection_list_row_selected(self, event: DataTable.RowSelected):
        ...
        # self.coll =  await app.get_collections_from_egeria(Egeria_config=self.Egeria_config, Search_str = self.selected_guid)
    ...
    #     DataProducts.update_collection_list(self.collections)
